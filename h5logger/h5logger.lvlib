...
<Library LVVersion="13008000">
	...
	<Item Name="HDF5 append data (BOOL 1D).vi" Type="VI" URL="../HDF5 append data (BOOL 1D).vi"/>
	...
	<Item Name="HDF5 append data (U8 1D).vi" Type="VI" URL="../HDF5 append data (U8 1D).vi"/>
